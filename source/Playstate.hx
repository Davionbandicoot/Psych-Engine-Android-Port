...
Security
Insights
Psych-Engine-Android-Port/source/PlayState.hx

jigsaw-4277821 Update (Bug Fix)
 1 contributor
4082 lines (3496 sloc)  113 KB
package;
...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['try harder', 0.5], //From 40% to 49%
		['Makin it', 0.6], //From 50% to 59%
...
var creditTxt:FlxText = new FlxText(4,healthBarBG.y + 20,0,("Port by Davion Bandicoot 64 "), 24);
